...
public class AutoDoubleSpeakerCenter extends SequentialCommandGroup {
  /** Creates a new AutoDoubleSpeakerCenter. */
  public AutoDoubleSpeakerCenter(Drive drive_sys, Arm arm_sys, Intake intake_sys, shooter shooter_sys) {
    ...
    addCommands(
      new ParallelCommandGroup(
        ...
        new PrepShooter(shooter_sys, intake_sys, k_SHOOTER.AUTO_CEN_SPEED)
      ),
      new WaitCommand(0.1),
      ...
      new ParallelCommandGroup(
        new AutoDrvStraight(drive_sys, 4),
      ...
      new SetRoller(intake_sys,0),
      new ArmPose(arm_sys, k_SETPOINTS.ARM_HOME, k_SETPOINTS.WRIST_HOME),
      new AutoDrvStraight(drive_sys, 4.8),
      new AutoDrvTurn(drive_sys, (side * 30.0))
      /* 
      new ParallelCommandGroup(
        new AutoDrvStraight(drive_sys, 18.4),
        new SequentialCommandGroup(
          new SetArmPosistions(arm_sys, k_SETPOINTS.INTAKE),
          new WaitCommand(1),
          new roller(intake_sys, k_INTAKE.PWR_FREE)
        )
      ),
      new roller(intake_sys, 0) 
      */
    );
  }
}
