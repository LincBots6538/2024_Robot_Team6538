...
public class AutoSpeakerOutside extends SequentialCommandGroup {
  /** Creates a new AutoSpeakerInside. */
  public AutoSpeakerOutside(Drive drive_sys, Arm arm_sys, Intake intake_sys, shooter shooter_sys) {
    ...
    addCommands(
      ...
      new ParallelCommandGroup(
        ...
        new PrepShooter(shooter_sys, intake_sys, k_SHOOTER.AUTO_SPEED)
      ),
      ...
      new ParallelCommandGroup(    
        ...
        new SequentialCommandGroup(
          new AutoDrvTurn(drive_sys, side * 67.0),
          new WaitCommand(0.5),
      ...
      new AutoDrvStraight(drive_sys, 1),
      new AutoDrvTurn(drive_sys, side * 67),
      new ParallelCommandGroup(
