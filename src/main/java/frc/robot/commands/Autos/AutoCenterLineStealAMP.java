...
public class AutoCenterLineStealAMP extends SequentialCommandGroup {
  /** Creates a new AutoCenterLineSteal.
   * @param amp1 1 for Amp side / -1 for Source Side
   */
  public AutoCenterLineStealAMP(Drive drive_sys, Arm arm_sys, Intake intake_sys, shooter shooter_sys) {
    ...
    addCommands(
      ...
      new ParallelCommandGroup(
        // Drive out to Center
        new AutoDrvStraight(drive_sys, 17.0),
        // Dump Held Note
      ...
      new ParallelCommandGroup(
        new SequentialCommandGroup(
          ...
          new AutoDrvStraight(drive_sys, 3.75)
        ),
        new SequentialCommandGroup(
      ...
      new ParallelCommandGroup(
        new SequentialCommandGroup(
          new AutoDrvTurn(drive_sys, side * -32.8),
          new AutoDrvStraight(drive_sys, 4.5)
        ),
        new SequentialCommandGroup(
          new ArmPose(arm_sys, k_SETPOINTS.ARM_INTAKE, k_SETPOINTS.WRIST_INTAKE),
          new SetRoller(intake_sys, k_INTAKE.PWR_FREE)
